...
WAV_EXT = "WAV.wav" # using wv since NIST took wav
...
if __name__ == "__main__":
    ...
    train = load_transcripts(os.path.join(path, "data/TRAIN"))
    build_json(train, path, "train")

    print("Preprocessing dev")
    transcripts = load_transcripts(os.path.join(path, "data/TEST"))
